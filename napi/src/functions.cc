...
Value N_handle_network_interface_event_callback(const CallbackInfo& info) {
    oc_interface_event_t event = static_cast<oc_interface_event_t>(info[0].As<Number>().Uint32Value());
...
Value N_handle_session_event_callback(const CallbackInfo& info) {
    ...
    oc_session_state_t state = static_cast<oc_session_state_t>(info[1].As<Number>().Uint32Value());
    (void)handle_session_event_callback(endpoint, state);
    return info.Env().Undefined();
}

Value N_oc_abort(const CallbackInfo& info) {
    std::string msg_ = info[0].As<String>().Utf8Value();
...
Value N_oc_allocate_message_from_pool(const CallbackInfo& info) {
    OCMemb& pool = *OCMemb::Unwrap(info[0].As<Object>());
...
Value N_oc_base64_decode(const CallbackInfo& info) {
    ...
    size_t len = static_cast<size_t>(info[1].As<Number>().Uint32Value());
...
Value N_oc_base64_encode(const CallbackInfo& info) {
    ...
    size_t input_len = static_cast<size_t>(info[1].As<Number>().Uint32Value());
    uint8_t* output_buffer = info[2].As<Buffer<uint8_t>>().Data();
    size_t output_buffer_len = static_cast<size_t>(info[3].As<Number>().Uint32Value());
...
Value N_oc_clock_encode_time_rfc3339(const CallbackInfo& info) {
    oc_clock_time_t time = static_cast<uint64_t>(info[0].As<Number>().Int64Value());
    char* out_buf = const_cast<char*>(info[1].As<String>().Utf8Value().c_str());
    size_t out_buf_len = static_cast<size_t>(info[2].As<Number>().Uint32Value());
...
Value N_oc_clock_parse_time_rfc3339(const CallbackInfo& info) {
    std::string in_buf_ = info[0].As<String>().Utf8Value();
    const char* in_buf = in_buf_.c_str();
    size_t in_buf_len = static_cast<size_t>(info[1].As<Number>().Uint32Value());
...
Value N_oc_clock_time_rfc3339(const CallbackInfo& info) {
    char* out_buf = const_cast<char*>(info[0].As<String>().Utf8Value().c_str());
    size_t out_buf_len = static_cast<size_t>(info[1].As<Number>().Uint32Value());
...
Value N_oc_concat_strings(const CallbackInfo& info) {
    OCMmem& concat = *OCMmem::Unwrap(info[0].As<Object>());
    std::string str1_ = info[1].As<String>().Utf8Value();
    const char* str1 = str1_.c_str();
    std::string str2_ = info[2].As<String>().Utf8Value();
...
Value N_oc_core_encode_interfaces_mask(const CallbackInfo& info) {
    ...
    oc_interface_mask_t iface_mask = static_cast<oc_interface_mask_t>(info[1].As<Number>().Uint32Value());
    (void)oc_core_encode_interfaces_mask(parent, iface_mask);
    return info.Env().Undefined();
}

Value N_oc_core_get_resource_by_index(const CallbackInfo& info) {
    int type = static_cast<int>(info[0].As<Number>());
...
Value N_oc_core_populate_resource(const CallbackInfo& info) {
    int core_resource = static_cast<int>(info[0].As<Number>());
    size_t device_index = static_cast<size_t>(info[1].As<Number>().Uint32Value());
    std::string uri_ = info[2].As<String>().Utf8Value();
    const char* uri = uri_.c_str();
    oc_interface_mask_t iface_mask = static_cast<oc_interface_mask_t>(info[3].As<Number>().Uint32Value());
    oc_interface_mask_t default_interface = static_cast<oc_interface_mask_t>(info[4].As<Number>().Uint32Value());
    int properties = static_cast<int>(info[5].As<Number>());
    ...
    int num_resource_types = static_cast<int>(info[10].As<Number>());
...
Value N_oc_create_discovery_resource(const CallbackInfo& info) {
    int resource_idx = static_cast<int>(info[0].As<Number>());
    size_t device = static_cast<size_t>(info[1].As<Number>().Uint32Value());
...
Value N_oc_dns_lookup(const CallbackInfo& info) {
    std::string domain_ = info[0].As<String>().Utf8Value();
    const char* domain = domain_.c_str();
    OCMmem& addr = *OCMmem::Unwrap(info[1].As<Object>());
    enum transport_flags flags = static_cast<enum transport_flags>(info[2].As<Number>().Uint32Value());
...
Value N_oc_get_collection_by_uri(const CallbackInfo& info) {
    std::string uri_path_ = info[0].As<String>().Utf8Value();
    const char* uri_path = uri_path_.c_str();
    size_t uri_path_len = static_cast<size_t>(info[1].As<Number>().Uint32Value());
    size_t device = static_cast<size_t>(info[2].As<Number>().Uint32Value());
...
Value N_oc_get_link_by_uri(const CallbackInfo& info) {
    OCCollection& collection = *OCCollection::Unwrap(info[0].As<Object>());
    std::string uri_path_ = info[1].As<String>().Utf8Value();
    const char* uri_path = uri_path_.c_str();
    int uri_path_len = static_cast<int>(info[2].As<Number>());
...
Value N_oc_get_next_collection_with_link(const CallbackInfo& info) {
    OCResource& resource = *OCResource::Unwrap(info[0].As<Object>());
    OCCollection& start = *OCCollection::Unwrap(info[1].As<Object>());
...
Value N_oc_handle_collection_request(const CallbackInfo& info) {
    ...
    oc_interface_mask_t iface_mask = static_cast<oc_interface_mask_t>(info[2].As<Number>().Uint32Value());
    OCResource& notify_resource = *OCResource::Unwrap(info[3].As<Object>());
...
Value N_oc_join_string_array(const CallbackInfo& info) {
    OCStringArray& ocstringarray = *OCStringArray::Unwrap(info[0].As<Object>());
    OCMmem& ocstring = *OCMmem::Unwrap(info[1].As<Object>());
...
Value N_oc_link_set_interfaces(const CallbackInfo& info) {
    ...
    oc_interface_mask_t new_interfaces = static_cast<oc_interface_mask_t>(info[1].As<Number>().Uint32Value());
...
Value N_oc_mem_trace_add_pace(const CallbackInfo& info) {
    std::string func_ = info[0].As<String>().Utf8Value();
    const char* func = func_.c_str();
    int size = static_cast<int>(info[1].As<Number>());
    int type = static_cast<int>(info[2].As<Number>());
    void* address = info[3];
...
Value N_oc_memb_init(const CallbackInfo& info) {
    OCMemb& m = *OCMemb::Unwrap(info[0].As<Object>());
    (void)oc_memb_init(m);
    return info.Env().Undefined();
}
...
Value N_oc_message_add_ref(const CallbackInfo& info) {
    OCMessage& message = *OCMessage::Unwrap(info[0].As<Object>());
