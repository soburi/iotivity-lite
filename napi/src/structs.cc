...
Napi::Function OCCollection::GetClass(Napi::Env env) {
    auto func = DefineClass(env, "OCCollection", {
        ...
        InstanceMethod("get_collections", &OCCollection::get_collections),
...
Napi::Function OCEndpoint::GetClass(Napi::Env env) {
    auto func = DefineClass(env, "OCEndpoint", {
        ...
        InstanceMethod("string_to_endpoint", &OCEndpoint::string_to_endpoint),
        ...
        InstanceMethod("set_local_address", &OCEndpoint::set_local_address),
...
Napi::Function OCRepresentation::GetClass(Napi::Env env) {
    auto func = DefineClass(env, "OCRepresentation", {
        ...
        InstanceMethod("parse", &OCRepresentation::parse),
        InstanceMethod("set_pool", &OCRepresentation::set_pool),
        InstanceMethod("get_encoded_payload_size", &OCRepresentation::get_encoded_payload_size),
        InstanceMethod("get_encoder_buf", &OCRepresentation::get_encoder_buf),
        InstanceMethod("add_boolean", &OCRepresentation::add_boolean),
        InstanceMethod("add_byte_string", &OCRepresentation::add_byte_string),
        InstanceMethod("add_double", &OCRepresentation::add_double),
        InstanceMethod("add_text_string", &OCRepresentation::add_text_string),
        InstanceMethod("clear_cbor_errno", &OCRepresentation::clear_cbor_errno),
        InstanceMethod("close_array", &OCRepresentation::close_array),
        InstanceMethod("close_object", &OCRepresentation::close_object),
        InstanceMethod("delete_buffer", &OCRepresentation::delete_buffer),
        InstanceMethod("end_array", &OCRepresentation::end_array),
        InstanceMethod("end_links_array", &OCRepresentation::end_links_array),
        InstanceMethod("end_object", &OCRepresentation::end_object),
        InstanceMethod("end_root_object", &OCRepresentation::end_root_object),
        InstanceMethod("get_rep_from_root_object", &OCRepresentation::get_rep_from_root_object),
        InstanceMethod("new_buffer", &OCRepresentation::new_buffer),
        InstanceMethod("object_array_start_item", &OCRepresentation::object_array_start_item),
        InstanceMethod("object_array_end_item", &OCRepresentation::object_array_end_item),
        InstanceMethod("oc_array_to_bool_array", &OCRepresentation::oc_array_to_bool_array),
        InstanceMethod("oc_array_to_double_array", &OCRepresentation::oc_array_to_double_array),
        InstanceMethod("oc_array_to_int_array", &OCRepresentation::oc_array_to_int_array),
        InstanceMethod("oc_array_to_string_array", &OCRepresentation::oc_array_to_string_array),
        InstanceMethod("open_array", &OCRepresentation::open_array),
        InstanceMethod("open_object", &OCRepresentation::open_object),
        InstanceMethod("set_boolean", &OCRepresentation::set_boolean),
        InstanceMethod("set_bool_array", &OCRepresentation::set_bool_array),
        InstanceMethod("set_byte_string", &OCRepresentation::set_byte_string),
        InstanceMethod("set_double", &OCRepresentation::set_double),
        InstanceMethod("set_double_array", &OCRepresentation::set_double_array),
        InstanceMethod("set_key", &OCRepresentation::set_key),
        InstanceMethod("set_long", &OCRepresentation::set_long),
        InstanceMethod("set_long_array", &OCRepresentation::set_long_array),
        InstanceMethod("set_string_array", &OCRepresentation::set_string_array),
        InstanceMethod("set_text_string", &OCRepresentation::set_text_string),
        InstanceMethod("set_uint", &OCRepresentation::set_uint),
        InstanceMethod("start_array", &OCRepresentation::start_array),
        InstanceMethod("start_links_array", &OCRepresentation::start_links_array),
        InstanceMethod("start_object", &OCRepresentation::start_object),
        InstanceMethod("start_root_object", &OCRepresentation::start_root_object),
...
Napi::Function OCCred::GetClass(Napi::Env env) {
    auto func = DefineClass(env, "OCCred", {
        ...
        InstanceMethod("read_credusage", &OCCred::read_credusage),
        InstanceMethod("read_encoding", &OCCred::read_encoding),
        InstanceMethod("parse_credusage", &OCCred::parse_credusage),
        InstanceMethod("parse_encoding", &OCCred::parse_encoding),
        InstanceMethod("credtype_string", &OCCred::credtype_string),
...
Napi::Function OCUuid::GetClass(Napi::Env env) {
    auto func = DefineClass(env, "OCUuid", {
        ...
        InstanceMethod("str_to_uuid", &OCUuid::str_to_uuid),
        InstanceMethod("uuid_to_str", &OCUuid::uuid_to_str),
        InstanceMethod("gen_uuid", &OCUuid::gen_uuid),
