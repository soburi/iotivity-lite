...
public:
    ...
    static Napi::Value get_next_collection_with_link(const Napi::CallbackInfo& info);
    static Napi::Value get_collection_by_uri(const Napi::CallbackInfo& info);
    static Napi::Value get_link_by_uri(const Napi::CallbackInfo& info);
...
public:
    ...
    static Napi::Function GetClass(Napi::Env);
    static Napi::FunctionReference constructor;
    operator oc_collection_iterator_t*() {
        return m_pvalue.get();
    }
    Napi::Value get_value(const Napi::CallbackInfo&);
    void set_value(const Napi::CallbackInfo&, const Napi::Value&);
...
public:
    ...
    static Napi::Function GetClass(Napi::Env);
    static Napi::FunctionReference constructor;
    operator oc_cloud_context_iterator_t*() {
        return m_pvalue.get();
    }
    Napi::Value get_value(const Napi::CallbackInfo&);
    void set_value(const Napi::CallbackInfo&, const Napi::Value&);
...
public:
    ...
    static Napi::Function GetClass(Napi::Env);
    static Napi::FunctionReference constructor;
    operator oc_link_params_iterator_t*() {
        return m_pvalue.get();
    }
    Napi::Value get_value(const Napi::CallbackInfo&);
    void set_value(const Napi::CallbackInfo&, const Napi::Value&);
...
public:
    ...
    static Napi::Function GetClass(Napi::Env);
    static Napi::FunctionReference constructor;
    operator oc_event_callback_iterator_t*() {
        return m_pvalue.get();
    }
    Napi::Value get_value(const Napi::CallbackInfo&);
    void set_value(const Napi::CallbackInfo&, const Napi::Value&);
...
public:
    ...
    static Napi::Function GetClass(Napi::Env);
    static Napi::FunctionReference constructor;
    operator oc_message_iterator_t*() {
        return m_pvalue.get();
    }
    Napi::Value get_value(const Napi::CallbackInfo&);
    void set_value(const Napi::CallbackInfo&, const Napi::Value&);
